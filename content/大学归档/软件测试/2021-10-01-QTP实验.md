...
![image-20211031191227451](https://pic.firehomework.top/2025/03/a580b7aa59a25ee280b375df5ce6eab2.webp)
...
![image-20211013212034346](https://pic.firehomework.top/2025/03/f16d8006ab7e2f847b7106ce8eb87bca.webp)
...
![image-20211013212134761](https://pic.firehomework.top/2025/03/ba12d9889efe539cc7d4994d32a9fbcc.webp)

右键 - 快速分区

![image-20211013212153863](https://pic.firehomework.top/2025/03/2131d627e1a4ab7509c4c8eaa8add25d.webp)
...
![image-20211013212610959](https://pic.firehomework.top/2025/03/f19f0de232e28208b7f6f8a6bb3e6c75.webp)点击Ghost备份还原：

![image-20211013212225067](https://pic.firehomework.top/2025/03/11651dd89db9e366d260ff148f11c087.webp)

点击下拉按钮会自动搜索到

![image-20211013212641965](https://pic.firehomework.top/2025/03/6b17f6adf00ec03837b31fcd4a73ec26.webp)

之后点击确定，会出来一个框，等他加载完并消失之后，重启即可。

![image-20211013212742351](https://pic.firehomework.top/2025/03/ffac172467e98aadd14f69f7edc2e844.webp)
...
![image-20211013213119908](https://pic.firehomework.top/2025/03/d954ea994e50ab09c422187f3c133c3f.webp)

这里会有一个设备。它名字有的时候显示不清楚，打开看看是不是这样：

![image-20211013213143682](https://pic.firehomework.top/2025/03/d93ca7489aa3a3c76f13d4ab22ecf823.webp)
...
![image-20211013213502310](https://pic.firehomework.top/2025/03/adf6c1b7effc83f10f2a3dd574f926aa.webp)
...
![image-20211013221659412](https://pic.firehomework.top/2025/03/06b20ff089554a6f2cb685dbae3958ad.webp)
...
![image-20211013222135138](https://pic.firehomework.top/2025/03/5354c20df6a42b0aa40ca9d5bd026091.webp)

第一次点击否：

![image-20211013222146377](https://pic.firehomework.top/2025/03/fa6ba76fdbdabbaa2ea5798ec9114b5c.webp)

然后再点击是：

![image-20211013222157426](https://pic.firehomework.top/2025/03/c2b822d529e07eb4dc2f9b15bd221943.webp)

![image-20211013222216343](https://pic.firehomework.top/2025/03/0fe0e70d7b0494fab48bb0a88776e152.webp)

安装一下必备组件什么的。

全部安装完成之后再次弹出：

![image-20211013222340596](https://pic.firehomework.top/2025/03/9e334979f7bd4b5df9560ae7ce1d0397.webp)

继续点否

![image-20211013222407868](https://pic.firehomework.top/2025/03/228a0ec2cd29b494e3ec0acdd1c0370a.webp)

接下来就是一路下一步。路径建议别改，这样后面的脚本你就不用改任何东西了。

安装之后如图：

![image-20211013222914284](https://pic.firehomework.top/2025/03/6629cf6feb658b30e63a4786c7e49bd1.webp)

点击运行，一会儿会出现这个窗口：

![image-20211013222936017](https://pic.firehomework.top/2025/03/a6cb9fb9ddf6a5f6a23f0ce6460d27ca.webp)

从刚刚让你用记事本打开的那个文件里找到第一个#之前的东西，粘贴进去。

![image-20211013223018226](https://pic.firehomework.top/2025/03/089eab35a9627a9347c79aa296dbc4a9.webp)

继续一路next。

![image-20211013223036179](https://pic.firehomework.top/2025/03/3f7b7f410e83bb855ee5f9bbb9c70d10.webp)
...
![image-20211013231915981](https://pic.firehomework.top/2025/03/397a5f913e1465a0a17f354e5b134ff7.webp)

你点击那个Action1:

![image-20211013231934146](https://pic.firehomework.top/2025/03/5eb2e274a499906be50509cc73a18737.webp)

就能改到Action1的部分，这就是dtLocalSheet，上面那个A,B,C可以双击之后改：

![image-20211013232013344](https://pic.firehomework.top/2025/03/b5ff3d9d5c782be096b65c312ff6f17f.webp)
...
![image-20211014224228499](https://pic.firehomework.top/2025/03/b84b6eda02f378f73f67ddb3bfe190cf.webp)

这次是随便的报错，接下来从这里找到Object Spy。

![image-20211014224256752](https://pic.firehomework.top/2025/03/5f5572a59ff99c5559d40af786d4422a.webp)

点击之后我们可以查看到Static：

![image-20211014224320523](https://pic.firehomework.top/2025/03/6e235affb32c26717844363062204933.webp)

（鼠标指向）

![image-20211014224339736](https://pic.firehomework.top/2025/03/8748b72ed7537a7b9c65af60e89329db.webp)

这是一个static，我们可以看到原本的筛选是靠"text"属性来确定的。

![image-20211014225112511](https://pic.firehomework.top/2025/03/017ae5ba51ae4829212aa14208bd253d.webp)

然后根据这种确定方式，我们发现这里面至少有两个Static，一个是那个叹号标识，一个是那个提示信息。

我们拉到values的最底端：

![image-20211014225424544](https://pic.firehomework.top/2025/03/2db620b6393c903a32c928e3ff3ca391.webp)
...
![image-20211014211752326](https://pic.firehomework.top/2025/03/4420219ed7b4e48a6c3df43d3ca52956.webp)

然后点击Global:

![image-20211014230120512](https://pic.firehomework.top/2025/03/219c081a6913d01d87007f825e818738.webp)

复制一份Action1的进入（这个操作是为了能让它重复这么多次）

进行测试：

![image-20211014230206925](https://pic.firehomework.top/2025/03/af6775edf1df2fb65344f981b160f0de.webp)

测试成功（最后一次成功，其他的失败，正常）

查看错误项：

![image-20211014230233909](https://pic.firehomework.top/2025/03/bea8228fe9b5739dd06811f7dc65a5b7.webp)

查看正确项：

![image-20211014230254078](https://pic.firehomework.top/2025/03/ea38a7456b9f2238e4077e42ec17a92a.webp)
...
![image-20211014231642020](https://pic.firehomework.top/2025/03/ad271d6c011ebb898b7d034d85c1ebc2.webp)
...
![image-20211014233514322](https://pic.firehomework.top/2025/03/33a7a752fde1ca8a69b323523da37c14.webp)

之后填入用户名和密码：

![image-20211014233554912](https://pic.firehomework.top/2025/03/d3d7d850c9926c7d5fa7106fd212fe4c.webp)

填入时间，Fly from和Fly to.

![image-20211014234256692](https://pic.firehomework.top/2025/03/9a7a3ef9137601a4d21f4745b9ee125b.webp)

点击Flights

![image-20211014234315538](https://pic.firehomework.top/2025/03/9dd9359b08bc5766e287e3d42477f272.webp)

点击一个Flights Table。

![image-20211014234339189](https://pic.firehomework.top/2025/03/d61c62813e071b9691e07870c7880d41.webp)

输入名称和订票数，点击订票

![image-20211014234406240](https://pic.firehomework.top/2025/03/ea1b533f0bd21947e2dc7727b7ce2273.webp)

![image-20211014234418125](https://pic.firehomework.top/2025/03/bcb838665dc9d1f8f651d1e53cfa52ce.webp)
...
![image-20211021205511020](https://pic.firehomework.top/2025/03/287ed18ff3e0d130f5ad467abd9a3167.webp)
...
![image-20211021210318162](https://pic.firehomework.top/2025/03/76e77b8caceffdff330093c872737a88.webp)
...
![image-20211021214624053](https://pic.firehomework.top/2025/03/5561e1daf7827dbb443fe0c66da00271.webp)

点一下之后点#：

![image-20211021214827866](https://pic.firehomework.top/2025/03/1a92849a792a601664e828b81042451f.webp)

然后修改需要正则的位置：

![image-20211021214958495](https://pic.firehomework.top/2025/03/a3b42f8ebf28c069e7f4f8535580bcc7.webp)

之后再次进行录制……然后也不知道是不是我的问题，我这里BUG了，能识别到Fax Order窗口，里面的啥东西都识别不到……

最后直接用了Analog recording:

![image-20211021220422426](https://pic.firehomework.top/2025/03/16308817097dea7b52ec76cf183f07f7.webp)

打开Fax Order之后直接录就行了，录完直接回放就OK。传真号码和右边的都能录制上。

![image-20211021221348376](https://pic.firehomework.top/2025/03/89c3f76d4b49e35114c2f12ce1259400.webp)
...
![image-20211021225212931](https://pic.firehomework.top/2025/03/7bb2f79ea7da9253937fcfa5f7229cee.webp)
